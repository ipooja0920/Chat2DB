...
import { Bookmark, Trash2, AlertCircle, BookmarkX, Code2 } from "lucide-react";
    ...
    <div className="bg-card border border-border rounded-2xl overflow-hidden hover:shadow-md transition-shadow group">
      ...
      {item.sql_query && (
        <div className="px-5 pb-3">
          ...
          <pre className="bg-secondary/60 rounded-lg px-3 py-2 text-[11px] font-mono text-foreground line-clamp-3 whitespace-pre-wrap border border-border/50">
            {item.sql_query}
          </pre>
        </div>
      )}
